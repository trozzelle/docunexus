...
$savedListMetaStmt = "DELETE FROM nxsidx_app.saved_lists WHERE userid = ? AND saveid = ?";
...
$savedListStmt = "DELETE FROM nxsidx_user_lists." . $userID . "_saved_lists WHERE userid = ? AND saveid = ?";
$savedListParams = array($userID, $saveID);
$db = db_conn('@nxsidx_app');
