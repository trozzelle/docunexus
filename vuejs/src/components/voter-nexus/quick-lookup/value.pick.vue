<template>
    <div class="modal fade" id="qValuePick" tabindex="-1" role="dialog" aria-labelledby="qValuePickLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="display-3"><i class="text-success fad fa-clipboard-list-check"></i> Choose values to include</h3>
                ...
                <div class="modal-body">    
                    ...
                    <div class="form-group row">
                        <div class="col-4" :key="k" v-for="(v, k) in filtered">                        
                ...
                <div class="modal-footer text-right">
                    <button type="button" class="btn btn-sm btn-success" v-on:click="saveValues()"><i class="fas fa-save"></i> Save</button>
